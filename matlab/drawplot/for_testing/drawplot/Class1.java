...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    {
        this(DrawplotMCRFactory.newInstance());
    }
    ...
    {
        this(DrawplotMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(DrawplotMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = DrawplotMCRFactory.newInstance();
